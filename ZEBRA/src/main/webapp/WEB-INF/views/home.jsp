...
.bootstrap-demo {
	...
	<h1 id="title" align="center"
		...
		<p class="lead" style="font-family: 'Nanum Gothic'; color: #dcdcdc">
			...
			divided into two depending on the position . <br> For the
			consumer while receiving provide a practical product review service
			assist in efficient purchase selection . For businesses to readily
			identify the consumer index , allows the strategic sales management .
			<br> In addition, the ultimate purpose of our service is to make
			a place for the community to build healthy consumption culture among
	...
	<div class="bootstrap-demo">
		<div class="row">
			...
			<div class="col-sm-6 col-md-4">
				...
				<div class="thumbnail">
					<!--  thumbnail 1  -->
					<img src="http://www.tutorialspark.com/twitterBootstrap/china.jpg"
						alt="china thumbnail">
					<!-- image 1 -->
					<div class="caption">
						<!-- caption -->
						<h3>The Great Wall of China</h3>
						<p>The Great Wall of China is a series of fortifications made
						...
						<p>
							<a href="#" class="btn btn-primary" role="button">Buy Tickets</a>
							<!-- btn 1 -->
				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p>The Statue of Liberty is a colossal neoclassical sculpture
							on Liberty Island in the middle of New York Harbor, in Manhattan,
							New York City.</p>
						<p>
							<a href="#" class="btn btn-primary" role="button">Buy Tickets</a>
							<!-- btn 1 -->
	...
	<img
		src="https://scontent.xx.fbcdn.net/t31.0-8/13247774_171391666592259_3132038665631639900_o.jpg"
		alt="china thumbnail">
