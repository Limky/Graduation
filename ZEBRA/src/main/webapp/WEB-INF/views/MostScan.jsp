	...
	<div class="container" style="padding:15px" >
		<div class="row">
			<div class="col-md-4" align="center">
				<h4 id="" style="font-family: fantasy; color: #7A7A7A"><a href="/ZEBRA/PopularProduct?category=<%=currentCategory%>">Popularity</a></h4>
			...
			<c:forEach var="MostScanProductsModel" items="${mostScanProductsModel}">
				...
				<div class="col-md-4 portfolio-item">
					...
					<button type="submit" class="btn btn-danger" name="barcode"
								value="${MostScanProductsModel.barcode}">Review</button>
								</form>
					</div>
